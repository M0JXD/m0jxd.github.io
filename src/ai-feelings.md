...
AI has consistently made mistakes for me. I'm a mediocre developer and all things considered. While I did ask ChatGPT to help me with some of the weird oddities with the CSS on this site (the footer and aligning the sitemap link), it took a while before we got there and really required me to have a good enough understanding of what was happening to phrase it in a way that the bot would understand. I asked Gemini to try and fix the image scaling before I ended up having to understand enough to make a solution that works how I wanted in 10 lines.

Another example is when ChatGPT generated syntactically incorrect C code for the IUP GUI I was drafting for Axe-FX II loader. Runtime bugs are one thing, but making code that won't even compile due to syntax errors is another.

## An old draft reply

This is an old drafted reply to a conversation I was having on a popular online forum that I never posted, I want to pull what I'm trying to say here into the page, but for now I've dumped it here for my reference as I get this page fixed up, and also because even without context it sums up a lot of my complex feelings very well.
...
Yes for the likes of Python and Bash they're pretty good - but it's quite easy to understand/verify the output in those languages. But there remains the copyright problem. Plus as I said, it sucks the fun out of doing it myself.
