...
I made the app in Processing. At the time, I chose Processing due to it's heavy recommendation in the short Arduino book, and I knew it's serial library should be easy to work with.
